...
public class PulseHopper extends Command {
    ...
    private static final double DEFAULT_PULSE_FORWARD_VOLTAGE = 2.0;
    private static final double DEFAULT_PULSE_REVERSE_VOLTAGE = -12.0;
    private static final double DEFAULT_PULSE_FORWARD_SEC = 0.2;
