...
public class CoreAutoOrig extends AutoCommandInterface {
    ...
    public static CoreAutoOrig getInstance(String[] pathFiles, CommandSwerveDrivetrain driveTrain, boolean isOutpostSide, double preloadShootTime,
            InternalButton virtualShootButton) {
        return new CoreAutoOrig(pathFiles, driveTrain, isOutpostSide, preloadShootTime, virtualShootButton);
    }
     ...
     * @param m_turret 
     */
    private CoreAutoOrig(String[] pathFiles, CommandSwerveDrivetrain driveTrain, boolean isOutpostSide,
