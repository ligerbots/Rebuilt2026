...
public class Turret extends SubsystemBase {
  ...
  public Turret() {
    ...
    slot0configs.kP = K_P; //TODO tune
    slot0configs.kI = 0.0;
    slot0configs.kD = 0.0;

    MotionMagicConfigs magicConfigs = talonFXConfigs.MotionMagic;
        
    magicConfigs.MotionMagicCruiseVelocity = MAX_VEL_ROT_PER_SEC; // Target cruise velocity of 80 rps //TODO Change values TOTAL GUESSES 
    magicConfigs.MotionMagicAcceleration = MAX_ACC_ROT_PER_SEC_SQ; // Target acceleration of 160 rps/s (0.5 seconds) 
