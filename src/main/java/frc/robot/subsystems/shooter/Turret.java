...
public class Turret extends SubsystemBase {
    ...
    private static final boolean DEFAULT_JAM_RECOVERY_ENABLED = false;
    private static final String JAM_RECOVERY_ENABLED_KEY = "turret/jamRecoveryEnabled";
    ...
    public Turret(Field2d field) {
        ...
        SmartDashboard.setDefaultBoolean(JAM_RECOVERY_ENABLED_KEY, DEFAULT_JAM_RECOVERY_ENABLED);
    ...
    private void optimizeCAN() {
        ...
        m_turretMotor.getStatorCurrent().setUpdateFrequency(Constants.ROBOT_FREQUENCY_HZ);
    ...
    public void periodic() {    
        if (isJamRecoveryEnabled()) {
            updateRecoveryState();
        } else if (m_recoveryState != RecoveryState.IDLE) {
            clearRecoveryState();
            holdCurrentPosition();
        }
        ...
        SmartDashboard.putBoolean("turret/jamRecoveryEnabled", isJamRecoveryEnabled());
        SmartDashboard.putBoolean("turret/stallRecoveryActive", isRecovering());
        SmartDashboard.putString("turret/recoveryState", m_recoveryState.toString());
    ...
    public boolean isRecovering() {
        return isJamRecoveryEnabled() && m_recoveryState != RecoveryState.IDLE;
    }
    ...
    private boolean isJamRecoveryEnabled() {
        return SmartDashboard.getBoolean(JAM_RECOVERY_ENABLED_KEY, DEFAULT_JAM_RECOVERY_ENABLED);
    }
    ...
    private void holdCurrentPosition() {
        m_goalDeg = getTurretAngleDeg();
        m_shootAngle = m_goalDeg;
        applyGoalPosition();
    }
